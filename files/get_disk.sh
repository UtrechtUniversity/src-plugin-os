...
workspace_file="/etc/rsc/workspace.json"
workspace_data=$(cat "$workspace_file")

# Parse workspace data to get required values
...
curl "https://gw.rsc-pilot2.surfresearchcloud.nl/workspace/workspaces/$workspace_id/" \
